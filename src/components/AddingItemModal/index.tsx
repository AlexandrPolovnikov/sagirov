...
const AddingItemModal = ({ onClose, onConfirm }: AddingItemModalProps): JSX.Element => {
    const [modalData, setModalData] = useState<ModalItemProps>(initialItem);

    const modalHandler = (event: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement>) => {
    ...
    const isCorrectUrl = (url: string) => {
        ...
        const regex = /(^https?:\/\/)?[a-z0-9~_\-\.]+\.[a-z]{2,9}(\/|:|\?[!-~]*)?$/i;
    ...
    return (
        <Modal.Wrapper>
                ...
                <div className="addingItemModal__inputs-box">
                    <div className="addingItemModal__left-content">
                        <div className="addingItemModal__preview">
                            <div className="addingItemModal__label">Задача:</div>
                            <Input
                                key="name"
                                name="name"
                        ...
                        <div className="addingItemModal__preview">
                            <div className="addingItemModal__label">Изображение:</div>
                            <Input
                                key="urlSrc"
                                name="image"
                        ...
                        <div className="addingItemModal__preview">
                            <div className="addingItemModal__label">Время:</div>
                            <Input
                                key="price"
                                name="price"
                                placeholder="Введите отведенное задаче время"
                    ...
                    <div className="addingItemModal__right-content">
                        <div className="addingItemModal__img flex-center">
                            {modalData.image ? (
                                ...
                                <span>
                                    После добавления ссылки, здесь должно появиться изображение.
                                    <br />
                                    Если изображения нет, значит ссылка не корректная.
                                    <br />
            ...
            <Modal.Footer>
                <Button text="Отменить" className="modal-button" onClick={onClose} />
                <Button
                    text="Добавить"
